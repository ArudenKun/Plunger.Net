...
public class PlungerDatabase
{
    ...
    public PlungerDatabase(string database)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PlungerDatabase"/> class with the provided database name and connection string.
    /// </summary>
    /// <param name="database">The name of the database.</param>
