...
namespace Plunger.Commons;

public class PlungerEmbedBuilder
{
    ...
    public PlungerEmbedBuilder WithTitle(string title)
    {
        Title = title;
        return this;
    }
    ...
    public PlungerEmbedBuilder WithDescription(string description)
    {
    ...
    public PlungerEmbedBuilder WithFooter(string footer)
    {
        Footer = footer;
        return this;
    }
    ...
    public PlungerEmbedBuilder WithStyle(EmbedStyle style)
    {
        Style = style;
        return this;
    }
